...
def main():
    ...
    if btn_validate or btn_upload:
        ...
        # --- FIX: SHOW DOWNLOAD BUTTON IMMEDIATELY ---
        # We read the file content now so it's available even if upload crashes later
        try:
        ...
        if failed:
            ...
            # --- FIX: REMOVED "upload" SUBCOMMAND ---
            # Correct: rdme openapi <file> [flags]
